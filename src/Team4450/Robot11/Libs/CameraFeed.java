...
import Team4450.Robot11.Libs.Grip.GripVisionPipeline;
import Team4450.Robot11.Libs.VisionPipelineModifier;
	...
	private void UpdateCameraImage()
    {
		...
		try
		{
			...
			{	
			    ...
			    if (result != 0) imageOutputStream.putFrame(modPipe.getModImage());
			}
		}
		catch (Throwable e)	{Util.logException(e);}
    }
